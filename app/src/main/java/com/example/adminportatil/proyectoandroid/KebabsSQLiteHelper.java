...
public class KebabsSQLiteHelper extends SQLiteOpenHelper {
    ...
    private void crearBd(SQLiteDatabase db){
        ...
        */
        ...
        //Kebabs
        db.execSQL("INSERT INTO tipo_kebab (nombre_tipo_carne, precio) VALUES ('Döner', 4.00)");
        db.execSQL("INSERT INTO tipo_kebab (nombre_tipo_carne, precio) VALUES ('Dürüm', 4.50)");
        db.execSQL("INSERT INTO tipo_kebab (nombre_tipo_carne, precio) VALUES ('Lahmacum', 5.00)");
        db.execSQL("INSERT INTO tipo_kebab (nombre_tipo_carne, precio) VALUES ('Shawarma', 4.50)");
        db.execSQL("INSERT INTO tipo_kebab (nombre_tipo_carne, precio) VALUES ('Gyros', 5.00)");

        db.execSQL("INSERT INTO tipo_carne (nombre_tipo_kebab, precio) VALUES ('Pollo', 0.50)");
        db.execSQL("INSERT INTO tipo_carne (nombre_tipo_kebab, precio) VALUES ('Ternera', 1.0)");
        db.execSQL("INSERT INTO tipo_carne (nombre_tipo_kebab, precio) VALUES ('Cordero', 0.50)");
