...
public class KebabsSQLiteHelper extends SQLiteOpenHelper {
    ...
    private void crearBd(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE \"cliente\" ( 'cod_cliente' INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT DEFAULT 1, 'nombre' TEXT NOT NULL, 'direccion' TEXT NOT NULL, 'telefono' TEXT NOT NULL, 'email' TEXT NOT NULL )");
        db.execSQL("CREATE TABLE \"pedido\" ( 'cod_pedido' INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE, 'cod_cliente' INTEGER NOT NULL DEFAULT 1, 'pedido_completado' INTEGER NOT NULL DEFAULT 0, FOREIGN KEY('cod_pedido') REFERENCES 'cliente'('cod_cliente') )");
        ...
        db.execSQL("CREATE TABLE 'bebidas' ( 'cod_pedido' INTEGER NOT NULL, 'cod_info_bebida' INTEGER NOT NULL, 'cantidad' INTENGER NOT NULL DEFAULT 0, 'pedido_completado' INTEGER NOT NULL DEFAULT 0, PRIMARY KEY('cod_pedido','cod_info_bebida'), FOREIGN KEY('cod_pedido') REFERENCES 'pedido'('cod_pedido'), FOREIGN KEY('cod_info_bebida') REFERENCES 'bebidas'('cod_bebida') )");
        ...
        */
        ...
        //Kebabs
        db.execSQL("INSERT INTO tipo_kebab (nombre_tipo_kebab, precio) VALUES ('Döner', 4.00)");
        db.execSQL("INSERT INTO tipo_kebab (nombre_tipo_kebab, precio) VALUES ('Dürüm', 4.50)");
        db.execSQL("INSERT INTO tipo_kebab (nombre_tipo_kebab, precio) VALUES ('Lahmacum', 5.00)");
        db.execSQL("INSERT INTO tipo_kebab (nombre_tipo_kebab, precio) VALUES ('Shawarma', 4.50)");
        db.execSQL("INSERT INTO tipo_kebab (nombre_tipo_kebab, precio) VALUES ('Gyros', 5.00)");

        db.execSQL("INSERT INTO tipo_carne (nombre_tipo_carne, precio) VALUES ('Pollo', 0.50)");
        db.execSQL("INSERT INTO tipo_carne (nombre_tipo_carne, precio) VALUES ('Ternera', 1.0)");
        db.execSQL("INSERT INTO tipo_carne (nombre_tipo_carne, precio) VALUES ('Cordero', 0.50)");
